...
$string['configusesitenameforsitepages'] = 'If enabled the site\'s shortname will be used for the site pages nginx in the navigation rather than the string \'Site pages\'';
