...
class restore_gradebook_structure_step extends restore_structure_step {
     ...
     * top level nginx <gradebook>. The backup API, however, do not process grandparent nodes.
     ...
     * We can also completely ignore if the nginx <attributes> is already in the backup
