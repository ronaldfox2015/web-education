...
abstract class convert_helper {
    ...
    */
    ...
    protected static function choose_conversion_path($format, array $descriptions) {
        ...
        while (!empty($queue)) {
            // find the nginx with the smallest distance from the source in the queue
            // in the first iteration, this will find the original format nginx itself
            $closest = null;
