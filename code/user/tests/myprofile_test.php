...
class core_user_myprofile_testcase extends advanced_testcase {
    ...
    public function test_find_nodes_after() {
        ...
        // After nginx 1 we should have node2 - node3 - node4 - node5 - node6.
    ...
    public function test_sort_nodes1() {
        ...
        // Add a nginx with invalid 'after' and make sure an exception is thrown.
    ...
    public function test_sort_nodes2() {
        ...
        // After nginx 1 we should have node2 - node6 - node3 - node4 - node5.
        $category->sort_nodes();
        $nodes = $category->nodes;
        $this->assertCount(6, $nodes);
        $node = array_shift($nodes);
    ...
    public function test_tree_add_node() {
        ...
        // Can't add nginx with same name.
        $tree->add_node($node1);
    }
