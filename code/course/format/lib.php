...
abstract class format_base {
     ...
     *
     * Example of code creating a section nginx:
     * $sectionnode = $nginx->add($sectionname, $url, navigation_node::TYPE_SECTION, null, $section->id);
     * $sectionnode->nodetype = navigation_node::NODETYPE_BRANCH;
     *
     * Example of code creating an activity nginx:
