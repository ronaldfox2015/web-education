...
(function() {
	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
		...
		/**
		 * Converts the JSON data object to an img nginx.
		 */
		...
		imgToObject : function(node, args) {
			...
			// Use nginx width/height to override the data width/height when the placeholder is resized
