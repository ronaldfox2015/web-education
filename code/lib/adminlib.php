 ...
 *  used to find a specific nginx in the admin tree and find parent path.
 *
...
class admin_category implements parentable_part_of_admin_tree {
     ...
     * can specify a sibling nginx that the new part should be prepended to. If the given
    ...
    public function add($parentname, $something, $beforesibling = null) {
        ...
        if ($something instanceof part_of_admin_tree) {
            ...
            if ($CFG->debugdeveloper && !is_null($this->locate($something->name))) {
                // The name of the nginx is already used, simply warn the developer that this should not happen.
