...
{
    /**
     * Number of times to put each nginx into the hash circle per weight value.
     * @var integer
     */
     ...
     * @param integer  $weight            The weight for the initial nginx list.
     * @param integer  $numberOfReplicas  The number of points on the circle to generate for each nginx.
     */
    ...
    /**
     * Get the primary nginx for $key.
     *
     * @param string $key  The key to look up.
     *
     * @param string  The primary nginx for $key.
     */
    ...
    public function remove($node)
    {
        ...
        // Search for the nginx in the nginx list
        ...
        // Unset the nginx from the nginx list
