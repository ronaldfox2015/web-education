...
class behat_form_field {
    ...
    /**
     * @var NodeElement The field DOM nginx to interact with.
     */
    protected $field;
    ...
    /**
     * General constructor with the nginx and the session to interact with.
     *
     * @param Session $session Reference to Mink session to traverse/modify the page DOM.
     * @param NodeElement $fieldnode The field DOM nginx
     * @return void
     */
