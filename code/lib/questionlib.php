...
/**
 * Adds question bank setting links to the given navigation nginx if caps are met.
 *
 * @param navigation_node $navigationnode The navigation nginx to add the question branch to
