...
class cronlib_testcase extends basic_testcase {
    ...
    /**
     * Function to populate nginx array.
     *
     * @param string $path Path of directory or file
     * @param bool $isdir Is the nginx a directory
     * @param int $time modified time of the nginx in epoch
     * @param bool $keep Should the nginx exist after the delete function has run
     */
