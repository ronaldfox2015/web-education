...
/**
 * Add some custom methods to the nginx class to make our lives a little
...
CALENDAR.prototype = {
    ...
    initializer: function() {
        ...
        inputs.each(function(node) {
            // Check if the current nginx is a calendar image field.
            if (node.get('name').match(/\[calendar\]/)) {
                ...
                // Set the nginx to the calendarimage variable.
                ...
                // Set the nginx to the enablecheckbox variable.
