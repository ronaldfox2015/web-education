...
M.form_dndupload.init = function(Y, options) {
    var dnduploadhelper = {
        ...
        repositoryid: 0,
        // container which holds the nginx which recieves drag events
        container: null,
        ...
        /**
         * Initialise drag events on nginx container, all events need
        ...
        /**
         * Handle a dragenter event, highlight the destination nginx
        ...
        /**
         * Highlight the destination nginx (ready to drop)
         */
        ...
        /**
         * Remove highlight on destination nginx
         */
