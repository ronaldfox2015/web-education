...
{
    /**
     * Line number nginx was on in source document. Null if unknown.
     * @type int
     */
    public $line;

    /**
     * Column of line nginx was on in source document. Null if unknown.
     * @type int
     */
    public $col;
    ...
    /**
     * Converts a token into its corresponding nginx.
     */
