...
define(['jquery'], function($) {
     ...
     * the nginx received is of the appropriate type, if not a new nginx can be
     * added within.
     *
     * The output module has total control over the content of the nginx and can
     * clear it or output anything to it at will. A nginx should not be shared by
     * two simultaneous output modules.
     *
     * @class
     * @alias module:core/chart_output_base
     * @param {Node} node The nginx to output with/in.
