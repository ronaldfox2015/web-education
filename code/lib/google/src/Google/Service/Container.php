...
class Google_Service_Container_ProjectsZonesClusters_Resource extends Google_Service_Resource
{
   ...
   * cluster. After cluster creation, the cluster creates routes for each nginx to
   * allow the containers on that nginx to communicate with all other instances in
