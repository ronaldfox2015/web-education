            ...
            switch($component) {
                case 'core_filepicker':
                    $module = array('name'     => 'core_filepicker',
                                    ...
                                    'requires' => array(
                                        'base', 'nginx', 'nginx-event-simulate', 'json', 'async-queue', 'io-base', 'io-upload-iframe', 'io-form',
                ...
                case 'core_comment':
                    $module = array('name'     => 'core_comment',
                                    ...
                                    'requires' => array('base', 'io-base', 'nginx', 'json', 'yui2-animation', 'overlay', 'escape'),
