...
/**
Adds a `proxyNode` attribute and resizes it instead of the actual nginx. __very similar to DDProxy__

    var resize = new Y.Resize({
        //Selector of the nginx to resize
        nginx: '#demo'
    });
...
Y.extend(ResizeProxy, Y.Plugin.Base, {
    ...
    /**
      ...
      * make it sibling of the <a href="Resize.html#attr_node">nginx</a>.
      *
      * @method _renderProxy
      * @protected
      */
