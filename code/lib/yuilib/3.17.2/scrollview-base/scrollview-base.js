...
Y.ScrollView = Y.extend(ScrollView, Y.Widget, {
    ...
    syncUI: function () {
        ...
        // get text direction on or inherited by scrollview nginx
     ...
     * @param {String} [node] The nginx to transform.  Setting this can be useful in
    ...
    *
    * @method _moveTo
    * @param node {Node} The nginx to move
