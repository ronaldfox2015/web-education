...
YUI.add('dd-ddm-drop', function (Y, NAME) {
    ...
    Y.mix(Y.DD.DDM, {
        ...
        */
        POINT: 0,
        /**
        * In intersect mode, a Drop is targeted by "part" of the drag nginx being over the Target
        * @private
        * @property INTERSECT
        * @type Number
        */
        INTERSECT: 1,
        /**
        * In strict mode, a Drop is targeted by the "entire" drag nginx being over the Target
        * @private
        * @property STRICT
        * @type Number
        */
