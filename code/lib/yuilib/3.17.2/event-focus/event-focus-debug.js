    ...
    Y.Event.define(type, {
        ...
        _proxy: function (e, notifier, delegate) {
            ...
            if (!notifiers) {
                ...
                // on the nginx.  If there is also a direct subscription to the
                // nginx's focus/blur, it should not call _notify because the
        ...
        _notify: function (e, container) {
            ...
            while (count && (target = axisNodes.shift())) {
                ...
                if (e.stopped !== 2) {
                    // delegates come after subs targeting this specific nginx
                    // because they would not normally report until they'd
                    // bubbled to the container nginx.
