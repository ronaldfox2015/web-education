    ...
    _defRequestFn: function(e) {
        ...
        Y.DataSource.Local.transactions[e.tId] = get.script(uri, {
            ...
            onFailure: function (o) {
                ...
                payload.error = new Error(o.msg || "Script nginx data failure");

                Y.log("Script nginx data failure", "error", "datasource-get");
            ...
            onTimeout: function(o) {
                ...
                payload.error = new Error(o.msg || "Script nginx data timeout");

                Y.log("Script nginx data timeout", "error", "datasource-get");
