...
This event can also be listened for using nginx.delegate().
...
Y.Event.define(EVT_TAP, {
    ...
    /**
    This function should set up the nginx that will eventually fire the event.

    Usage:

        nginx.on('tap', function (e) {
            Y.log('the nginx was tapped on');
        });
    ...
    **/
    ...
    nginx that should trigger the subscription callback.

    Usage:

        nginx.delegate('tap', function (e) {
            Y.log('li a inside nginx was tapped.');
        }, 'li a');
    ...
    **/
    ...
    Only used if you use nginx.delegate(...) instead of nginx.on(...);
