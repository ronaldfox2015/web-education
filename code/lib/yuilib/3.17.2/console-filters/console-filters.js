...
// Y.Plugin.ConsoleFilters prototype
{
    ...
    /**
     * The container nginx created to house the category filters.
     *
    ...
    /**
     * The container nginx created to house the source filters.
     *
     * @property _sources
     * @type Node
     * @protected
     ...
     * container nginx passes as the first arg.
     *
...
}, '3.17.2', {"requires": ["plugin", "console"], "skinnable": true});
