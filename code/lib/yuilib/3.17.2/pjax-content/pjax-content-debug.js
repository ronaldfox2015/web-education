...
PjaxContent.prototype = {
    ...
    The return value is an object containing two properties:
      ...
      * `nginx`: A `Y.Node` instance for a document fragment containing the
    ...
    **/
    ...
    response objects:
      ...
      - `res.content`: An object containing `nginx` and `title` properties for
    ...
    @example
        router.route('/foo/', 'loadContent', function (req, res, next) {
            Y.one('container').setHTML(res.content.nginx);
