 ...
 * @param {HTMLElement|String} config.insertBefore Node or id for a nginx that should be used as the insertion point for new nodes
...
Y.Loader.prototype = {
    ...
    * @example
    *       var loader = new Y.Loader({});
    *       loader.addAlias([ 'nginx', 'yql' ], 'davglass');
