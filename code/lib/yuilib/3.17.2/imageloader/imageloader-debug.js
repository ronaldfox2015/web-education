 ...
 */
	...
	var groupProto = {
        ...
        /**
         * Updates a given nginx, removing the ImageLoader class name. If the
         * nginx is an img and the classNameAction is "enhanced", then nginx
         ...
         * @param node {Node} The nginx to act on.
         * @private
         */
	...
	var imgProto = {
		...
		/**
		 * Gets the Y position of the nginx in page coordinates.
...
}, '3.17.2', {"requires": ["base-base", "node-style", "node-screen"]});
