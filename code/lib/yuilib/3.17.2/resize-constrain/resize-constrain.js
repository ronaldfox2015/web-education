...
/**
A Resize plugin that will attempt to constrain the resize nginx to the boundaries.
@module resize
...
Y.mix(ResizeConstrained, {
    ...
    ATTRS: {
        /**
        * Will attempt to constrain the resize nginx to the boundaries. Arguments:<br>
...
Y.extend(ResizeConstrained, Y.Plugin.Base, {
    ...
    _checkRatio: function() {
        ...
        // check whether the resizable nginx is closest to height or not
    ...
    /**
     * Check whether the resizable nginx is inside the constrain region.
     *
     * @method _checkRegion
     * @protected
     * @return {boolean}
