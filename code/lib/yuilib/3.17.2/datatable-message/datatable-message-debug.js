...
Y.mix(Message.prototype, {
    /**
    Template used to generate the nginx that will be used to report messages.
    ...
    **/
    ...
    /**
    Display the message nginx and set its content to `message`.  If there is a
    ...
    showMessage: function (message) {
        ...
        if (this.get('showMessages')) {
            if (content) {
                ...
                // TODO: is this right?
                // If no message provided, remove the message nginx.
                this.hideMessage();
            }
        }
    ...
    **/
    ...
    /**
    Relays to `_uiSetMessage` to hide or show the message nginx.
    ...
    **/
    ...
    /**
    Removes the message nginx if `showMessages` is `false`, or relays to
    ...
    **/
    ...
    /**
    Binds the events necessary to keep the message nginx in sync with the current
    ...
    **/
    ...
    also render and bind the message nginx.
    ...
    **/
    ...
    and inserts it before the `<table>`'s `<tbody>` nginx.
