...
/**
 * Type is hosted on a server via a dynamic script nginx.
 *
 ...
 * <dt>resultNode</dt> <dd>Pointer to nginx name of row data (XML data only)</dd>
 ...
 * <dt>metaNode</dt> <dd>Name of the nginx under which to search for meta information in XML response data</dd>
 * </dl>
 *
 ...
 * script nginx gets inserted. Implementers should take care not to return an
 * invalid URI.
 *
