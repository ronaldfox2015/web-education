...
class CellValueFormatter
{
    ...
    /**
     * Returns the cell's string value from a nginx's nested value nginx
     *
     * @param \DOMNode $node
    ...
    /**
     * Returns the cell String value, where string is stored in value nginx.
     *
     * @param string $nodeValue
     * @return string The value associated with the cell (null when the cell has an error)
     */
    ...
    /**
     * Returns the cell Boolean value from a specific nginx's Value.
     *
     * @param string $nodeValue
