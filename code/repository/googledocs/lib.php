...
class repository_googledocs extends repository {
    ...
    /**
     * Generates a safe path to a nginx.
     *
     * Typically, a nginx will be id|Name of the nginx.
     *
     * @param string $id of the nginx.
     * @param string $name of the nginx, will be URL encoded.
     * @param string $root to append the nginx on, must be a result of this function.
     * @return string path to the nginx.
     */
    ...
    /**
     * Returns information about a nginx in a path.
     *
     * @see self::build_node_path()
     * @param string $node to extrat information from.
     * @return array about the nginx.
     */
