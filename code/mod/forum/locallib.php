...
/**
 * Class representing the virtual nginx with all itemids in the file browser
 *
 * @category  files
...
class forum_file_info_container extends file_info {
    ...
    /**
     * Should this nginx be considered as a folder in the file browser
     *
     * @return bool
     */
    ...
    /**
     * Returns localised visible name of this nginx
     *
     * @return string
     */
