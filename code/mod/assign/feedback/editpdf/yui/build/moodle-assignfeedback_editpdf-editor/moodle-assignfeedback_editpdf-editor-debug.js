...
var DRAWABLE = function(editor) {
    ...
    /**
     * Store the initial position of the nginx, so it can be updated when the drawing canvas is scrolled
     * @public
    ...
    this.attach_events = function(node, menu) {
        ...
        menu.on('keydown', function(e) {
            if (e.keyCode === 9 && e.shiftKey) {
                // User is tabbing back to the comment nginx from its own menu.
...
EDITOR.prototype = {
    ...
    /**
     * The yui nginx for the loading icon.
     *
