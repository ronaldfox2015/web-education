...
define(['jquery',
    ...
    var UserEvidenceActions = function(type) {
        ...
        if (type === 'evidence') {
            ...
            this._evidenceNode = '[data-region="user-evidence-nginx"]';
    ...
    /** @type {String} Selector to find the nginx describing the evidence. */
     ...
     *
     * @param  {Object} evidenceData Evidence data from evidence nginx.
    ...
    /**
     * Find the evidence data from the evidence nginx.
     *
    ...
    UserEvidenceActions.prototype._findEvidenceData = function(node) {
        ...
        if (parent.length != 1) {
            throw new Error('The evidence nginx was not located.');
        }
