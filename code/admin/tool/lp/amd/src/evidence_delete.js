...
define(['jquery',
     ...
     *
     * @param {String} triggerSelector The nginx on which the click will happen.
     * @param {String} containerSelector The parent nginx that will be removed and contains the evidence ID.
     */
