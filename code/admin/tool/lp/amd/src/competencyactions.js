...
define(['jquery',
    ...
    /**
     * Respond to choosing the "Add" menu item for the selected nginx in the tree.
     * @method addHandler
     */
     ...
     * @param {Object} parent The current parent nginx in the tree
    ...
    /**
     * A nginx was chosen and "Move" was selected from the menu. Open a popup to select the target.
     * @param {Event} e
     * @method moveHandler
     */
    ...
    /**
     * Handler when a nginx in the aria tree is selected.
