...
Y.extend(DropDown, Y.Base, {
    ...
    updateEventsList: function() {
        ...
        // Mark the default choose nginx as visible and selected.
    ...
    /**
     * Method to update the selected nginx from the options list.
     *
     * @method updateSelection
     * @param {string} selection The options nginx value that should be selected.
     */
