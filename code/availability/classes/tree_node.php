...
abstract class tree_node {
    ...
    /**
     * Checks whether this nginx should be included after restore or not. The
     * nginx may be removed depending on restore settings, which you can get from
     * the $task object.
     *
    ...
    /**
     * Updates this nginx after restore, returning true if anything changed.
    ...
    /**
     * Updates this nginx if it contains any references (dependencies) to the
     * given table and id.
     *
